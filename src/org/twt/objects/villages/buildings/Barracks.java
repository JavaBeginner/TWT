...
/** This class represents a barracks building with its properties and calculations
 * 
 * @author JavaBeginner
 *
 */
...
{
    /** Construct a new barracks building object
     * 
     ...
     */
    public Barracks(String name, int maxLevel, int minLevel, int wood,
