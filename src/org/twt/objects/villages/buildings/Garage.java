...
/** This class represents a garage building with its properties and calculations
 * 
 * @author JavaBeginner
 *
 */
...
{
    /** Construct a new garage building object
     * 
     ...
     */
    public Garage(String name, int maxLevel, int minLevel, int wood,
