...
/** This class represents a snob building with its properties and calculations
 * 
 * @author JavaBeginner
 *
 */
public class Snob extends AbstractBuilding
{
    /** Construct a new snob building object
     * 
     ...
     */
    public Snob(String name, int maxLevel, int minLevel, int wood,
